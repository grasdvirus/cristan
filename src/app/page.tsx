              ...
              <Tabs value={activeTab} onValueChange={handleTabChange} className="w-auto">
                  ...
                  >
                   ...
                   <a
                      ...
                      className="inline-flex items-center justify-center whitespace-nowrap px-4 py-1.5 text-lg font-bold border-b-2 border-transparent hover:text-primary transition-colors"
                    >
                      Partenariat
                    </a>
                  </TabsList>
