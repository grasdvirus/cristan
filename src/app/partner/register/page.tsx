...
import { UnreadMessagesButton } from '@/components/partner/unread-messages-button';
        ...
        <div className="max-w-4xl mx-auto w-full">
            <div className="relative text-center mb-12">
                ...
                <div className="relative inline-block mt-2">
                    <div className="absolute -inset-2 sparkle-mask -z-10" aria-hidden="true">
                        <div className="absolute inset-0 sparkle-animation-content"></div>
                    </div>
            ...
            <NeumorphicCard>
                ...
                <div className="text-center my-4">
                    <span className={cn("text-4xl font-bold", isGoalReached && "text-green-500")}>{uses}</span>
                    <span className={cn("text-xl text-muted-foreground", isGoalReached && "text-green-500")}> / {REWARD_GOAL}</span>
                    <p className="text-sm text-muted-foreground mt-1">
                        {isGoalReached ? "Félicitations ! Vous pouvez réclamer votre récompense." : "utilisations avant la prochaine récompense"}
                    </p>
                </div>
...
const partnerFormSchema = z.object({
  ...
  socialLinks: z.array(socialLinkSchema).min(2, 'Veuillez ajouter au moins deux réseaux sociaux.'),
...
const PageWrapper = ({ children, showControls = false }: { children: React.ReactNode, showControls?: boolean }) => (
    <div className="container mx-auto px-4 py-16 sm:py-24">
        <div className="relative flex justify-between items-center mb-8 gap-4">
            ...
            {showControls && <UnreadMessagesButton />}
